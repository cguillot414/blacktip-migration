...
Run bayGraphs.py to get the graphs based off of the data in "Texas-blacktip-shark-data_Blacktip-size-data-for-analys.csv"
...
it is set up to allow any file to be inputted, either by typing into the python file itself or inputted into the console. 
This detail does need to be changed in the program code to be customized. 
